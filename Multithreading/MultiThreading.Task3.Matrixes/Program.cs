...
namespace MultiThreading.Task3.MatrixMultiplier
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            CreateAndProcessMatrices(matrixSize, matricesMultiplier);
            CreateAndProcessMatrices(matrixSize, matricesMultiplierParallel);
            Console.ReadLine();
        }

        private static void CreateAndProcessMatrices(byte sizeOfMatrix, IMatricesMultiplier matrixMultiplier)
        {
